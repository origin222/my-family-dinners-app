...
const App = () => {
    ...
    // --- HANDLERS AND CORE LOGIC (UNCHANGED) ---
        ...
        return (
            <div>
                <div className="flex justify-between items-center mb-6">
                    ...
                    {/* --- DAISYUI: Button with modifier classes --- */}
                    <button
                ...
                <div className="space-y-4">
                    {Object.keys(groupedList).sort().map(category => (
                        // --- DAISYUI: Collapse component for accordion effect ---
                            ...
                            <div className="collapse-content">
                                {groupedList[category].map((item, index) => {
                                    ...
                                    return (
                                        <div
                                            key={globalIndex}
                                            className={`flex items-center justify-between p-3 rounded-lg cursor-pointer transition ${item.isChecked ? 'opacity-50 line-through' : 'hover:bg-base-100'}`}
                ...
                {planData?.shoppingList?.length === 0 && (
                    <p className="text-center text-base-content/70 mt-10 p-6 bg-base-200 rounded-box">Your shopping list is empty! Ready for a new plan?</p>
                )}
            </div>
        );
    };
    ...
    const ReviewView = () => (
        <div>
            ...
            <div className="flex flex-col sm:flex-row gap-4 mb-6">
                ...
                {/* --- DAISYUI: Button with accent color --- */}
                <button
                        ...
                        <div key={index} className={`card bg-base-100 shadow-xl transition-all duration-300 ${isSelected ? 'border-2 border-accent' : ''}`}>
                            <div className="card-body">
                                ...
                                <div className="card-actions justify-between items-center mt-4 pt-4 border-t border-base-300">
                                    {/* --- DAISYUI: Form control with checkbox --- */}
            ...
            <div className="p-8 bg-base-200 rounded-box text-center">
                ...
                <div className="form-control w-full max-w-xs mx-auto">
                    <label className="label">
                        <span className="label-text">What time do you need dinner ready?</span>
                    </label>
                    <input
                        type="time"
                        value={dinnerTime}
                        ...
                        step="300"
                        // --- DAISYUI: Input with border ---
                        className="input input-bordered text-center text-2xl font-mono"
                    />
                </div>
                ...
                <button
                    ...
                    disabled={isLoading}
                    // --- DAISYUI: Button with a different color ---
                    className="btn btn-success mt-6 w-full max-w-xs"
                >
        ...
        return (
            <div className="space-y-10">
                <header className="text-center border-b border-base-300 pb-4">
                    ...
                    {!isFavorite && (
                        <button
                            ...
                            className="btn btn-secondary btn-sm mt-4 gap-2"
                        >
                    ...
                    {isFavorite && (
                        <p className="mt-4 text-sm text-secondary font-medium flex items-center justify-center gap-2">
                            <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><path fillRule="evenodd" d="M3.172 5.172a4 4 0 015.656 0L10 6.343l1.172-1.171a4 4 0 115.656 5.656L10 17.657l-6.828-6.829a4 4 0 010-5.656z" clipRule="evenodd"></path></svg>
                            Saved to Favorites
                        </p>
                    )}
                ...
                <div>
                    ...
                    {/* --- DAISYUI: Steps component for timeline --- */}
                ...
                <div>
                    <h3 className="text-3xl font-bold mb-5">Full Ingredient List</h3>
                ...
                <div>
                    <h3 className="text-3xl font-bold mb-5">Cooking Instructions</h3>
    ...
    const FavoritesView = () => (
        <div>
            ...
            <div className="space-y-4">
                {favorites.length === 0 ? (
                    <p className="text-center p-6 bg-base-200 rounded-box">
